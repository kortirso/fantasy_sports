...
# rubocop: disable Style/RescueStandardError, Style/RedundantBegin, Rails/FilePath, Lint/SuppressedException
...
# rubocop: enable Style/RescueStandardError, Style/RedundantBegin, Rails/FilePath, Lint/SuppressedException

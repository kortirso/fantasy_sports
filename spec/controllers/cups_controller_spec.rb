      ...
      context 'for existing cup' do
        ...
        context 'for existing fantasy team' do
          ...
          before do
            ...
            cups_round1 = create :cups_round, cup: cup, week: lineup1.week
            cups_round2 = create :cups_round, cup: cup, week: lineup2.week
            create :cups_pair, home_lineup: lineup1, cups_round: cups_round1
            create :cups_pair, visitor_lineup: lineup2, cups_round: cups_round2
          end

...
rpl2022.teams.each.with_index do |team, team_index|
  ...
  10.times do |index|
    user = Users::CreateService.call(params: { email: "football-team-#{team_index}-#{index}@gmail.com", password: '1234qwerQWER', password_confirmation: '1234qwerQWER' }, with_send_confirmation: false).result
    FantasyTeams::GenerateSampleService.call(season: rpl2022, user: user, favourite_team_uuid: team.uuid)
  end
end
